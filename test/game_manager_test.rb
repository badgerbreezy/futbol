...
class GameManagerTest < MiniTest::Test
  ...
  def test_game_manager_can_get_ids_of_games_in_season
    assert_equal %w[2013020674 2013020177], @game_manager.get_season_game_ids('20132014')
  end
  ...
  def test_it_can_find_worst_coach
    @game_manager.tracker.stubs(:find_worst_coach).returns('John Tortorella')
    assert_equal 'John Tortorella', @game_manager.worst_coach('20162017')
  end
end
